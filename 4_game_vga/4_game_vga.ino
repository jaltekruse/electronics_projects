...
void drawPaddles(){ // Pong
    ...
    //rightPaddleY += (wheelOnePosition / 80);
    x = RIGHT_PADDLE_X; 
    ...
    //leftPaddleY += (wheelTwoPosition / 80);
    x = LEFT_PADDLE_X;
...
void drawStartMenu(){
  ...
  //       vgaPrint(str1, 50, 44, 1); 
  //  }
  //  if (wheelOnePosition > 500 ) {
  //     vgaPrint(str5, 56, 44, 1); 
  //  }
  //  if (wheelOnePosition > 100 ) {
  //     vgaPrint(str6, 64, 44, 1); 
  //  }
  //  if (wheelOnePosition > 10 ) {
  //     vgaPrint(str7, 70, 44, 1); 
  //  }
  //     if (wheelOnePosition > 1 ) {
  //     vgaPrint(str9, 76, 44, 1); 
  //  }
  //  vgaPrint(str40, 38, 44, 1); 
   if(scoreR == 7) {vgaPrint(str7, 64, 4, 2);}
   vga.delay(50);
   processInputs(); 
   if (buttonTwoStatus == 1){
